...
if ($current_term) {
    $term_name = ucfirst($current_term->name); // Перша буква велика
}
?>
                ...
                while ($the_query->have_posts()) : $the_query->the_post(); ?>
                    <div class="item" data-aos="fade-up" data-aos-delay="<?php echo ($i - 1) % 3 + 1;?>00">
                        ...
                        <a href="<?php the_permalink(); ?>">
                                <?php
                                $terms = get_the_terms(get_the_ID(), 'category_tour');
                        ...
                        <div class="item-desc">
                            ...
                            <div class="item-bottom">
                                ...
                                <?php } ?>
                                <a href="<?php echo esc_url(get_the_permalink()); ?>" class="item-book btn btn-red">Book</a>
                            </div>
                        </div>
                    </div>
                    <?php
