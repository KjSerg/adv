...
$template_path = '';
$template_path = get_the_ID() ? get_post_meta(get_the_ID(), '_wp_page_template', true) : '';
...
<head>
	...
	<?php if($template_path == 'promo-page.php'){
    ...
    <div class="container">
        ...
        <?php if ($social_links) : ?>
            ...
            <ul>
                <?php foreach ($social_links as $social_link) : ?>	
                    <li>
                        <a href="<?php echo $social_link['link']?>" target="_blank"><?php echo $social_link['text']?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
            </div>
        ...
        <div class="header-info">
            <div class="header-lang">
                <div class="header-lang__title"><span><?php echo pll_current_language(); ?></span><img src="<?php echo get_template_directory_uri(); ?>/img/down.svg" alt="down"></div>
                <?php
